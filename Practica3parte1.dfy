...
/*
    ...
    Diseña algoritmos recursivos para calcular el producto escalar de
    dos vectores de enteros dado, no nulos y de igual longitud, primero
    planteando una inmersion no final, y segundo, una inmersion final,
    sustituyendo la constante 0 por una nueva variable n.
